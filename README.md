The software tracks the limit cycle oscillations of arbitrary ordinary differential equations (ODEs) and the steady-states of second-order diffusive parabolic diffusive equations (PDEs).
